...
function getInstallCommand(scriptPath = "", isAlpine = false, useGitea = false) {
  const githubUrl = `https://raw.githubusercontent.com/Heretek-AI/${basePath}/main/${scriptPath}`;
  const giteaUrl = `https://git.community-scripts.org/Heretek-AI/${basePath}/raw/branch/main/${scriptPath}`;
