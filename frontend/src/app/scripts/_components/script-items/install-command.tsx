...
function getInstallCommand(scriptPath = "", isAlpine = false, useGitea = false) {
  const githubUrl = `https://raw.githubusercontent.com/community-unscripted/${basePath}/main/${scriptPath}`;
  const giteaUrl = `https://git.community-scripts.org/community-unscripted/${basePath}/raw/branch/main/${scriptPath}`;
